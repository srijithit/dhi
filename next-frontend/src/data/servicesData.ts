...
export const SERVICES_DATA: Service[] = [
  {
    ...
    heroTitle: "Professional Website Development Services in Coimbatore",
    heroSub: "Your website is your first impression. At DhiGrowth, we design and develop custom, fast-loading, mobile-responsive websites that not only look great but are built to convert visitors into customers. From business websites and landing pages to e-commerce platforms and web portals, every website we build is SEO optimised, secure, and scalable. Whether you are a startup looking for your first website or an established business ready for a revamp we deliver websites that work as hard as you do.",
