...
export const SERVICES_DATA: Service[] = [
  {
    ...
    headline: "Website Development Company in Coimbatore",
    fullDescription: "DhiGrowth builds custom, fast-loading, and SEO-friendly websites that help businesses in Coimbatore grow online from stunning designs to powerful functionality.",
  ...
  },
  {
    id: "ai-development",
    name: "AI Development",
    headline: "AI Development Company in Coimbatore",
    ...
    shortCopy: "Innovative AI solutions, machine learning models, and smart automation tailored for business growth.",
    category: "ai",
    iconName: "Cpu",
    badge: "Future Tech",
  ...
  },
  {
    ...
    headline: "AI Automation Development Company in Coimbatore",
    ...
    shortCopy: "Intelligent automation solutions that streamline operations, reduce costs, and enhance productivity.",
    category: "ai",
    iconName: "Zap",
    badge: "Efficiency",
  ...
  },
  {
    ...
    headline: "WhatsApp Marketing Company in Coimbatore",
    ...
    shortCopy: "Targeted campaigns and automated messaging via WhatsApp Business API that drive engagement and sales.",
    category: "marketing",
  ...
  },
  {
    ...
    headline: "Business Development in Coimbatore",
    ...
    shortCopy: "Strategic consulting, partnerships, and market expansion strategies tailored for sustainable growth.",
    category: "strategy",
    iconName: "TrendingUp",
    badge: "Strategic",
  ...
  },
  {
    id: "seo",
    name: "SEO",
    headline: "SEO Company in Coimbatore",
    ...
    shortCopy: "Expert SEO strategies, on-page optimisation, link building, and local SEO to drive organic rankings and leads.",
    category: "marketing",
    iconName: "Search",
    badge: "Organic Reach",
  ...
  },
  {
    ...
    headline: "Digital Marketing Company in Coimbatore",
    ...
    shortCopy: "Full-funnel digital marketing strategies, SEO, PPC ads, and social media campaigns built for ROI and brand growth.",
    category: "marketing",
    iconName: "BarChart3",
    badge: "Full Funnel",
  ...
  },
  {
    ...
    headline: "Social Media Marketing Company in Coimbatore",
    ...
    shortCopy: "Engaging social media campaigns, content creation, paid ads, and brand building across Instagram, Facebook, and LinkedIn.",
    category: "marketing",
    iconName: "Share2",
    badge: "Brand Voice",
  ...
  },
  {
    ...
    headline: "Google Ads Company in Coimbatore",
    ...
    shortCopy: "Targeted Google Ads & Meta advertising campaigns that maximise ROAS, drive high-intent traffic, and boost conversions.",
    category: "marketing",
    iconName: "Target",
    badge: "ROI Focused",
  ...
  },
  {
    id: "ads-shooting",
    name: "Ads Shooting",
    headline: "Ads Shooting Company in Coimbatore",
    ...
    shortCopy: "Professional ad film production, commercial shoots, brand videos, and high-impact visual storytelling.",
    category: "creative",
    iconName: "Video",
  ...
  },
  {
    id: "video-editing",
    name: "Video Editing",
    headline: "Video Editing Company in Coimbatore",
    ...
    shortCopy: "Professional video editing, motion graphics, colour grading, and post-production for brand storytelling and social reach.",
    category: "creative",
    iconName: "Film",
