  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 font-body">
        ...
        {/* 3D Coverflow Container with Motion Drag & Touch Swipe */}
        <div className="relative flex flex-col items-center justify-center min-h-[420px] mb-12">
          
          {/* Navigation Arrow Left */}
          <button
            onClick={handlePrev}
            className="absolute -left-2 sm:left-2 lg:left-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full bg-white dark:bg-[#111625] border border-slate-200 dark:border-slate-800 shadow-xl flex items-center justify-center text-slate-700 dark:text-white hover:text-[#2196E8] hover:border-[#2196E8] transition-all cursor-pointer hover:scale-110"
            aria-label="Previous capability"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>

          {/* Cards Stack with Touch / Drag Gestures */}
          <motion.div
            drag="x"
            ...
            className="relative w-full max-w-[850px] h-[360px] flex items-center justify-center cursor-grab active:cursor-grabbing select-none"
          >
            {capabilities.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute w-[280px] sm:w-[340px] h-[340px] rounded-3xl overflow-hidden shadow-2xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-[#0c111d] cursor-pointer group select-none"
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-6 flex flex-col justify-end pointer-events-none select-none">
          ...
          <button
            onClick={handleNext}
            className="absolute -right-2 sm:right-2 lg:right-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 rounded-full bg-white dark:bg-[#111625] border border-slate-200 dark:border-slate-800 shadow-xl flex items-center justify-center text-slate-700 dark:text-white hover:text-[#2196E8] hover:border-[#2196E8] transition-all cursor-pointer hover:scale-110"
