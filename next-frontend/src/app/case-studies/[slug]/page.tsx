...
export default function DynamicCaseStudyPage({
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#000000] text-slate-900 dark:text-white font-body selection:bg-[#2196E8] selection:text-white transition-colors duration-300">
      ...
      <main className="subpage-padding-top font-body">

        {/* ── HERO SECTION ── */}
        <section className="relative py-16 sm:py-24 bg-white dark:bg-[#000000] border-b border-slate-100 dark:border-slate-800/80 overflow-hidden font-body">
          {/* Background Watermark */}
          <div className="absolute right-0 top-1/3 pointer-events-none select-none opacity-[0.03] dark:opacity-[0.05] text-[140px] lg:text-[180px] font-extrabold tracking-tight text-[#2196E8] hidden lg:block font-body leading-none truncate max-w-full capitalize">
            {study.title}
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 font-body">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-5">
                <Link
                  href="/case-studies"
                  className="inline-flex items-center gap-2 text-slate-500 dark:text-slate-400 hover:text-[#2196E8] text-sm font-medium transition-colors mb-1 font-body"
                >
                ...
                <div className="flex items-center space-x-4">
                  <div
                    className="w-16 h-16 rounded-2xl shadow-lg flex items-center justify-center text-white font-extrabold text-2xl shrink-0 border-2 overflow-hidden font-body"
                  ...
                  <div>
                    ...
                    <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight font-body">
                      {study.title} {isMobileApp ? 'mobile app' : 'platform'}
                    </h1>
                  </div>
                </div>

                <p className="text-slate-600 dark:text-slate-300 text-base sm:text-lg leading-relaxed font-normal whitespace-pre-line font-body">
                  {study.about}
                </p>
                ...
                <div className="flex flex-wrap items-center gap-3.5 pt-2 font-body">
                  {primaryLiveUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-white font-bold text-sm shadow-md hover:scale-105 transition-all cursor-pointer font-body"
                  ...
                  <Link
                    href="/contact"
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800 font-bold text-sm transition-colors font-body"
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                >
                  <div className="relative w-full h-[320px] sm:h-[400px] flex items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between z-20 font-body">
                      ...
                      <div
                        className="px-3.5 py-1.5 rounded-full text-white text-xs font-bold shadow-lg tracking-wide font-body"
                        style={{ backgroundColor: study.brandColor }}
                      >
                        Live
                      </div>
              ...
              <div className="lg:col-span-5 space-y-6 font-body">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div
                    className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl border-2 object-cover shadow-xl shrink-0 flex items-center justify-center font-extrabold text-2xl text-white overflow-hidden font-body"
                    style={{ backgroundColor: study.brandColor, borderColor: study.brandColor }}
                  >
                    <img
                      src={study.image}
        ...
        <section className="py-16 sm:py-24 bg-gradient-to-b from-white via-slate-50 to-slate-100 dark:from-[#000000] dark:via-[#070911] dark:to-[#0b0f19] border-b border-slate-200 dark:border-slate-800 overflow-hidden relative font-body">
          <div
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 font-body">
              {parsedHighlights.map((c, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-white dark:bg-[#0b0f19] rounded-2xl border border-slate-200/80 dark:border-slate-800 p-6 shadow-sm hover:shadow-lg transition-all space-y-3 group hover:border-[#2196E8] font-body"
                >
        ...
        <section className="py-16 bg-slate-50 dark:bg-[#070911] border-t border-slate-200 dark:border-slate-800 font-body">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-14 font-body">
              <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight font-body">
                {study.title} capabilities and engineering
              </h2>
            </div>

            <div className="space-y-0 font-body">
              {/* Product Objective Banner */}
              <div className="w-full py-12 sm:py-16 border-b border-slate-200/80 dark:border-slate-800 font-body">
                  ...
                  <div className="lg:col-span-7 space-y-6 font-body">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 font-body">
                      <div className="p-4 rounded-2xl bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-100/80 dark:border-emerald-900/40 flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-sm font-bold text-slate-900 dark:text-white font-body">Sub-second loading</h4>
                          <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5 font-body">Optimized for instant responsiveness and sub-second asset streaming.</p>
                        </div>
                      </div>
                      ...
                      <div className="p-4 rounded-2xl bg-blue-50/70 dark:bg-blue-950/30 border border-blue-100/80 dark:border-blue-900/40 flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="text-sm font-bold text-slate-900 dark:text-white font-body">Smart cloud engine</h4>
                          <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5 font-body">Automated workflow synchronization and enterprise-grade SLA reliability.</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {solutionItems.map((item, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="w-full py-12 sm:py-16 lg:py-20 border-b border-slate-200/80 dark:border-slate-800 last:border-0 font-body"
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                      {isLeft ? (
                        <>
                          <div className="lg:col-span-5 flex justify-center items-center">
                            <div className="w-full bg-gradient-to-br from-blue-500/10 via-slate-100/40 to-slate-200/50 dark:from-[#0b0f19] dark:to-[#121927] rounded-3xl p-8 text-center space-y-4 hover:scale-105 transition-transform duration-500 border border-slate-200 dark:border-slate-800 shadow-md font-body">
                              <div
                                className="w-16 h-16 rounded-2xl text-white flex items-center justify-center text-3xl mx-auto shadow-md font-body"
                                style={{ backgroundColor: study.brandColor }}
                              >
                              ...
                              <span className="text-sm font-extrabold tracking-wide block font-body" style={{ color: study.brandColor }}>
                                {title}
                              </span>
                              ...
                              <div className="flex justify-center gap-2 pt-1 flex-wrap font-body">
                                <span className="px-3 py-1 bg-slate-900 dark:bg-slate-800 text-white rounded-lg text-xs font-bold font-body">Fast</span>
                                <span className="px-3 py-1 bg-emerald-600 text-white rounded-lg text-xs font-bold font-body">Automated</span>
                          ...
                          <div className="lg:col-span-7 space-y-5 font-body">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 font-body">
                              <div className="p-4 rounded-xl bg-slate-100/80 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 flex items-center space-x-3">
                                ...
                                <span className="font-semibold text-slate-800 dark:text-slate-200 text-sm font-body">Componentized UI architecture</span>
                              </div>
                              <div className="p-4 rounded-xl bg-slate-100/80 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 flex items-center space-x-3">
                                <Cpu className="w-4 h-4 text-emerald-500" />
                                <span className="font-semibold text-slate-800 dark:text-slate-200 text-sm font-body">Real-time cloud state engine</span>
                              </div>
                            </div>
                          </div>
                        </>
                        ...
                        <>
                          <div className="lg:col-span-7 space-y-5 order-2 lg:order-1 font-body">
                            ...
                            <div className="flex gap-3 pt-2 flex-wrap font-body">
                              <span className="px-4 py-2 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400 rounded-xl text-xs font-bold font-body">
                                Live verified
                              </span>
                              <span className="px-4 py-2 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-400 rounded-xl text-xs font-bold font-body">
                                99.9% uptime
                              </span>
                              <span className="px-4 py-2 bg-violet-50 dark:bg-violet-950/40 border border-violet-200 dark:border-violet-800 text-violet-700 dark:text-violet-400 rounded-xl text-xs font-bold font-body">
                                Cloud scalable
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="lg:col-span-5 flex justify-center items-center order-1 lg:order-2">
                            <div className="w-full bg-gradient-to-br from-emerald-500/10 via-slate-100/40 to-slate-200/50 dark:from-[#0b0f19] dark:to-[#121927] rounded-3xl p-8 text-center space-y-4 hover:scale-105 transition-transform duration-500 border border-slate-200 dark:border-slate-800 shadow-md font-body">
                              <div className="w-16 h-16 rounded-2xl bg-emerald-500 text-white flex items-center justify-center text-3xl mx-auto shadow-md font-body">
                                <CheckCircle2 className="w-8 h-8" />
                              </div>
                              <span className="text-sm font-extrabold tracking-wide text-emerald-600 dark:text-emerald-400 block font-body">
                                Verified output
                              </span>
                              <p className="text-xs text-slate-600 dark:text-slate-400 font-body">
          ...
          <div className="w-full max-w-4xl mx-auto px-6 text-center relative z-20 space-y-8 font-body">
            <div className="flex justify-center">
              <div className="relative group cursor-pointer">
                ...
                />
                <div
                  className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-3xl border-2 object-cover shadow-2xl transition hover:scale-105 overflow-hidden flex items-center justify-center font-extrabold text-4xl text-white font-body"
                  style={{ backgroundColor: study.brandColor, borderColor: study.brandColor }}
                >
                  <img
                    src={study.image}
            ...
            <div className="inline-flex items-center space-x-3 px-7 py-3.5 rounded-full bg-[#0A0F17] hover:bg-[#121B2B] border border-emerald-500/50 text-emerald-400 text-lg sm:text-xl font-extrabold shadow-[0_0_35px_rgba(16,185,129,0.35)] cursor-pointer transition hover:scale-105 font-body">
              <span className="text-2xl animate-bounce">🎉</span>
              <span className="bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-300 bg-clip-text text-transparent tracking-wide font-body">
            ...
            <div className="flex flex-wrap items-center justify-center gap-5 pt-4 font-body">
              {playstoreMatch && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-4 px-8 py-4 rounded-2xl bg-[#090E17] hover:bg-[#0E1524] border border-emerald-500/40 hover:border-emerald-400 text-white font-medium shadow-[0_0_25px_rgba(16,185,129,0.25)] transition transform hover:-translate-y-1 font-body"
                >
          ...
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 font-body">
            ...
            >
              ...
              <div className="text-left font-body">
                ...
                <span className="font-bold text-sm sm:text-base font-body">{prevStudy.title}</span>
              </div>
            </Link>
            ...
            >
              <div className="text-right font-body">
                ...
                <span className="font-bold text-sm sm:text-base font-body">{nextStudy.title}</span>
              </div>
