...
export default function DynamicCaseStudyPage({
      ...
      <div className="min-h-screen bg-slate-50 dark:bg-[#070910] text-slate-900 dark:text-white font-body selection:bg-[#2196E8] selection:text-white">
        ...
        <main className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="relative w-full max-w-2xl rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-xl mb-8 bg-slate-50 dark:bg-slate-900 group">
              <img
                src="/images/under_construction_banner.png"
                alt="Case Study In Development"
                className="w-full h-auto max-h-[380px] object-cover transition-transform duration-700 group-hover:scale-105 select-none"
              />
            </div>
  ...
  const showcaseImageMap: Record<string, string[]> = {
    ...
    'sanikas-restaurant': [
      '/images/case-studies/sanikas-restaurant/showcase_1.webp',
      '/images/case-studies/sanikas-restaurant/showcase_2.webp',
      '/images/case-studies/sanikas-restaurant/showcase_3.webp',
      '/images/case-studies/sanikas-restaurant/showcase_4.webp',
      '/images/case-studies/sanikas-restaurant/showcase_5.webp',
      '/images/case-studies/sanikas-restaurant/showcase_6.webp',
    ],
    'sanikas': [
      '/images/case-studies/sanikas-restaurant/showcase_1.webp',
      '/images/case-studies/sanikas-restaurant/showcase_2.webp',
    ...
    'startten': [
      ...
      '/images/case-studies/startten/showcase_2.png',
      '/images/case-studies/startten/showcase_3.png',
      '/images/case-studies/startten/showcase_4.png',
      '/images/case-studies/startten/showcase_5.png',
      '/images/case-studies/startten/showcase_6.png',
    ],
    'amaravathy-coir': [
      '/images/case-studies/amaravathy/showcase_1.webp',
      '/images/case-studies/amaravathy/showcase_2.webp',
      '/images/case-studies/amaravathy/showcase_3.webp',
      '/images/case-studies/amaravathy/showcase_4.webp',
      '/images/case-studies/amaravathy/showcase_5.webp',
      '/images/case-studies/amaravathy/showcase_6.webp',
    ],
    'amaravathy': [
      '/images/case-studies/amaravathy/showcase_1.webp',
      '/images/case-studies/amaravathy/showcase_2.webp',
    ...
    'keystone': [
      '/images/case-studies/keystone/showcase_1.webp',
      '/images/case-studies/keystone/showcase_2.webp',
      '/images/case-studies/keystone/showcase_3.webp',
      '/images/case-studies/keystone/showcase_4.webp',
      '/images/case-studies/keystone/showcase_5.webp',
      '/images/case-studies/keystone/showcase_6.webp',
    ],
    'kiipl': [
      '/images/case-studies/keystone/showcase_1.webp',
      '/images/case-studies/keystone/showcase_2.webp',
    ...
    'thoorigai': [
      '/images/case-studies/thoorigai/showcase_1.webp',
      '/images/case-studies/thoorigai/showcase_2.webp',
      '/images/case-studies/thoorigai/showcase_3.webp',
      '/images/case-studies/thoorigai/showcase_4.webp',
      '/images/case-studies/thoorigai/showcase_5.webp',
      '/images/case-studies/thoorigai/showcase_6.webp',
    ],
    'gigabull': [
      '/images/case-studies/gigabull/showcase_1.webp',
      '/images/case-studies/gigabull/showcase_2.webp',
      '/images/case-studies/gigabull/showcase_3.webp',
      '/images/case-studies/gigabull/showcase_4.webp',
  ...
  const highlightItems = Array.from({ length: 3 }).map((_, i) => {
    ...
    if (study.slug === 'amaravathy-coir' || study.slug === 'amaravathy') {
      const amaravathyScreens = [
        '/images/case-studies/amaravathy/highlight_1.png',
        '/images/case-studies/amaravathy/highlight_2.png',
        '/images/case-studies/amaravathy/highlight_3.png',
      ];
      const amaravathyTitles = [
        'Global Coir Manufacturing & Export Portal',
        'Sustainable Coir Fibre & Geotextile Products',
        'Eco-Friendly Dyeing, ZLD & Infrastructure',
      ];
      const amaravathyDescs = [
        'High-credibility B2B digital gateway engineered for domestic and global distributors, bulk buyers, and international supply contracts.',
        'Structured industrial catalogue showcasing premium coir fibre, curled coir, yarn-dyed mats, and natural geotextiles with technical specs.',
        'Measurable sustainability narrative detailing the Zero Liquid Discharge (ZLD) Effluent Treatment Plant and eco-friendly manufacturing scale.',
      ];
      return {
        id: i,
        icon: i === 0 ? <Zap className="w-5 h-5 text-[#2196E8]" /> : i === 1 ? <MapPin className="w-5 h-5 text-[#2196E8]" /> : <Database className="w-5 h-5 text-[#2196E8]" />,
        title: amaravathyTitles[i],
        desc: amaravathyDescs[i],
        screen: amaravathyScreens[i],
      };
    }
